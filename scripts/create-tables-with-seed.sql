-- Script SQL complet : Création des tables + Seed avec hash correct
...
-- ============================================
-- Hash du mot de passe "admin123" (généré avec bcrypt, 12 rounds)
...
VALUES (
    ...
    '$2a$12$aGvvGrqhwWi1jt2XAzib3Ov3fBybqGpBs7rkm7sn/n656Rrq.8yN6', -- Hash de "admin123"
    'ADMIN',
    'Admin',
    'Pharmacie',
    true,
...
-- Templates SMS par défaut (sans conflit)
...
-- ============================================
SELECT '✅ Tables créées avec succès! Utilisateur admin créé (admin@pharmacie.local / admin123)' as message;
